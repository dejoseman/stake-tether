...
export default function WhyTether() {
  const benefits = [
    {
      ...
      text: 'Tether tokens are the most widely adopted stablecoins, having pioneered the concept in the digital token space.',
    },
    {
      title: 'Built on Multiple Blockchains',
      text: 'Tether tokens are built on multiple blockchains, offering easy integration and adoption. Supported blockchains include Algorand, Avalanche, Simple Ledger Protocol (SLP), Ethereum, EOS, Liquid Network, Omni, Polygon, Tezos, Tron, Solana, and Statemine.',
    },
    {
    ...
    },
    {
      ...
      text: 'All Tether tokens are pegged at 1-to-1 with a matching fiat currency and are backed 100% by Tether\'s reserves.',
    },
    {
    ...
    },
    {
      ...
      text: 'Tether tokens represent multiple fiat currencies, including USD (USDt), EUR (EURt), MXN (MXNt), and CNH (CNHt).',
    },
    {
      title: 'World-Class Support',
      text: 'Tether offers world-class customer support and onboarding for businesses and individuals alike.',
    },
  ]
  ...
  const disruptors = [
    ...
    {
      title: 'For Merchants',
      text: 'Integrating Tether tokens opens up an array of opportunities for consumers to purchase products and services seamlessly across a variety of merchants and platforms.',
    },
    {
      title: 'For Exchanges',
      ...
      <section className="hero" style={{ minHeight: '400px' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: 0 }}>
            <h1 className="hero__title">Why use Tether?</h1>
